    ...
    <div className="min-h-screen bg-[#f7f8fb] text-[#050816]">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="border border-slate-300 px-6 py-3 rounded-xl font-black hover:bg-slate-50"
            >
              Publish Property
            </button>
        ...
        <section className="px-6 pt-8">
          <div className="bg-white rounded-[32px] shadow-xl border border-slate-200 p-6">
            ...
            <p className="text-slate-500">
              Iyi search ya rent tuzayongeramo filters zayo nyuma.
            </p>
          </div>
        </section>
      )}
      ...
      {mode === "sell" && (
        <section className="px-6 pt-8">
          <div className="bg-white rounded-[32px] shadow-xl border border-slate-200 p-6">
            <h2 className="text-3xl font-black mb-4">
              Tangira kugurisha property yawe
            </h2>
            <button
              onClick={() => setShowSellerForm(true)}
              className="bg-pink-600 text-white px-8 py-4 rounded-2xl font-black"
            >
              Publish Property
            </button>
          </div>
      ...
      <section className="px-6 py-10">
        <div className="mb-8">
          <h2 className="text-4xl font-black">Properties ziri ku isoko</h2>
