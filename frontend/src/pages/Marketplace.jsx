...
const rwandaLocations = {
  ...
  Southern: ["Huye", "Muhanga", "Nyanza", "Gisagara", "Nyamagabe", "Ruhango", "Kamonyi", "Nyaruguru"],
  Eastern: ["Kayonza", "Kirehe", "Ngoma", "Bugesera", "Nyagatare", "Rwamagana", "Gatsibo"],
...
const initialProperties = [
  ...
  },
  {
    ...
    verified: true,
    description: "Inzu nziza yo guturamo iri ahantu hizewe kandi heza.",
    image:
...
export default function Marketplace() {
  ...
  function handlePublish(e) {
    ...
    const newProperty = {
      ...
      size: form.size || "N/A",
      agent: form.owner || "BuildWise Seller",
      verified: true,
      image:
        form.image ||
            ...
            <form onSubmit={handlePublish} className="space-y-8">
              <div className="grid md:grid-cols-2 gap-5">
                ...
                <select
                  ...
                  className="bg-slate-50 rounded-2xl px-5 py-5 outline-none text-lg disabled:opacity-50"
                >
                  <option value="">Hitamo District</option>
                  {form.province &&
                ...
                <textarea
                  ...
                  className="md:col-span-2 bg-slate-50 rounded-2xl px-5 py-5 outline-none text-lg min-h-[160px]"
                />
              </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {filteredProperties.map((property) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl font-black mb-3">{property.type}</h3>
